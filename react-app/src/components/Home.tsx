...
const Home: FC<HomeProps> = ({ toggleChat }) => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center px-6 py-12 lg:px-20 overflow-hidden">
      ...
      {/* Light Yellow Themed Floating Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-20 w-72 h-72 bg-yellow-200/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-yellow-300/8 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-yellow-100/8 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
      ...
      <div ref={ref} className={`relative max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center z-10 transition-all duration-1000 ${
        ...
        <div className="order-2 lg:order-2 text-gray-800 space-y-8">
          {/* Main Heading */}
          ...
          <div className={`overflow-hidden h-12 transition-all duration-700 delay-700 ${
            ...
            <p className="text-xl md:text-2xl lg:text-3xl text-gray-600 font-light leading-relaxed">
              I am a <span className="relative">
                <span className="font-semibold text-yellow-600 inline-block transition-all duration-500">
                  {roles[currentRoleIndex]}
                </span>
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-yellow-500 to-amber-500 transform scale-x-0 transition-transform duration-500"></span>
              </span>
            </p>
          </div>
          ...
          <div className={`flex gap-4 pt-4 transition-all duration-700 delay-900 ${
            ...
            <a
              ...
              className="group relative w-12 h-12 bg-white/80 hover:bg-white border-2 border-gray-200 hover:border-yellow-400 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-yellow-500/30 overflow-hidden"
              aria-label="GitHub"
            >
              <svg className="w-6 h-6 text-gray-700 group-hover:text-yellow-600 relative z-10 transition-all duration-300 group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className={`flex flex-wrap items-center gap-6 pt-8 transition-all duration-700 delay-1100 ${
            ...
            <a
              ...
              className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-yellow-400 via-yellow-500 to-amber-500 hover:from-yellow-300 hover:via-yellow-400 hover:to-amber-400 text-gray-800 font-bold rounded-2xl transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-yellow-500/50 focus:outline-none focus:ring-4 focus:ring-yellow-500/50 overflow-hidden"
            >
              {/* Rotating border */}
            ...
            <button
              onClick={toggleChat}
              className="group relative px-8 py-4 bg-white/80 hover:bg-white text-gray-700 hover:text-yellow-600 font-bold rounded-2xl border-2 border-gray-200 hover:border-yellow-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-yellow-500/30 focus:outline-none focus:ring-4 focus:ring-yellow-500/50 overflow-hidden"
            >
              {/* Button content */}
